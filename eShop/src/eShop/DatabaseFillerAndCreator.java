...
public class DatabaseFillerAndCreator extends DBManager{ //change
	...
	public DatabaseFillerAndCreator(){
		...
		addUserToDb("user", "user", "user@user.com", "1234", "isra", null, null, false, null);
		addUserToDb("admin", "admin", "admin@admin.com", "5678", "isra", null, null, true, null);
	}
}
